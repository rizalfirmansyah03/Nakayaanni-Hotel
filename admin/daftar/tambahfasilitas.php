    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid pb-1 bg-white">
            <div class="container text-center">
                <br>
                <h1 class="display-6" style="font-family:geneva;">Tambah Data</h1>
            </div>
        </div>
			...
			<main>
				<div class="container-fluid px-3 py-2">
                    <div class="card mb-4">
	                    ...
	                    <form action="insertfasilitas.php" method="POST" enctype="multipart/form-data">
		                    ...
		                    <ul style="background-color: #E4E9F7;">
                                <div class="mb-3">
                                    ...
                                    <input type="" class="form-control" name="id_fasilitas" id="id_fasilitas" required>
		                        </div>
                                <div class="mb-3">
				                    <label for="nama_fasilitas">Nama Fasilitas : </label>
                                    <input type="" class="form-control" name="nama_fasilitas" id="nama_fasilitas" required>
		                        </div>
                                <div class="mb-3">
				                    <label for="gambar_fasilitas">Gambar : </label>
                                    <input type="file" name="gmbr" id="gmbr" class="form-control-file" required>
		                        </div>
                                <div class="mb-3">
				                    <label for="keterangan">Keterangan : </label>
                                    <textarea type="text" class="form-control" rows="5" name="keterangan" id="keterangan" required ></textarea>
		                        </div>
			                    <div class="mb-3">
