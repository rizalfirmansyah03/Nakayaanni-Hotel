<?php
    ...
    $id = $_GET["id"];
    $psn = "SELECT * FROM tb_deskripsi WHERE id_deskripsi = '$id'";
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #000000;">
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                <li class="nav-pills">
                    <a class="nav-link text-white" href="deskripsi.php">  
                        Kembali
			...
			<main>
				<div class="container-fluid px-3 py-2">
                    <div class="card mb-4">
	                    ...
	                    <form action="editdeskripsi.php" method="POST">
		                    <input type="hidden" name="id_deskripsi" value="<?php echo $d["id_deskripsi"]; ?>">
		                    <ul style="background-color: #E4E9F7;">
			                    <div class="mb-3">
				                    <label for="deskripsi">Deskripsi : </label>
                                    <textarea type="text" class="form-control" rows="9" name="deskripsi" id="deskripsi" required ><?php echo $d["deskripsi"]; ?></textarea>
		                        </div>
			                    <div class="mb-3">
