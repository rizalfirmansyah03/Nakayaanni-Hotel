<?php
    ...
    $id = $_GET["id"];
    $psn = "SELECT * FROM tb_fitur WHERE id_fitur = '$id'";
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #000000;">
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                <li class="nav-pills">
                    <a class="nav-link text-white" href="fitur.php">  
                        Kembali
			...
			<main>
				<div class="container-fluid px-3 py-2">
                    <div class="card mb-4">
	                    ...
	                    <form action="editfitur.php" method="POST">
		                    <input type="hidden" name="id_fitur" value="<?php echo $d['id_fitur']; ?>">
		                    <ul style="background-color: #E4E9F7;">
			                    <div class="mb-3">
				                    <label for="jenis_fitur">Jenis Fitur : </label>
                                    <input type="" class="form-control" name="jenis_fitur" id="jenis_fitur" required value="<?php echo $d["jenis_fitur"]; ?>">
		                        </div>
			                    <div class="mb-3">
