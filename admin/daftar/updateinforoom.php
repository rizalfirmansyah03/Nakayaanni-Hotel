<?php
    ...
    $id = $_GET["id"];
    $psn = "SELECT * FROM tb_infokamar WHERE id_infokamar = '$id'";
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #000000;">
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                <li class="nav-pills">
                    <a class="nav-link text-white" href="inforoom.php">  
                        Kembali
			...
			<main>
				<div class="container-fluid px-3 py-2">
                    <div class="card mb-4">
	                    ...
	                    <form action="editinforoom.php" method="POST" enctype="multipart/form-data">
		                    <input type="hidden" name="id_infokamar" value="<?php echo $d['id_infokamar']; ?>">
		                    <ul style="background-color: #E4E9F7;">
			                    <div class="mb-3">
				                    <label for="id_room">ID Room : </label>
                                    <input type="" class="form-control" name="id_room" id="id_room" readonly value="<?php echo $d["id_room"]; ?>">
		                        </div>
                                <div class="mb-3">
				                    <label for="nama_room">Nama Room : </label>
                                    <input type="" class="form-control" name="nama_room" id="nama_room" required value="<?php echo $d["nama_room"]; ?>">
		                        </div>
                                <div class="mb-3">
				                    <label for="gambar">Gambar : </label>
                                    <input type="" class="form-control" name="gambar" id="gambar" readonly value="<?php echo $d["gambar"]; ?>">
		                        </div>
                                <div class="mb-3">
                                    <img src="../../asset/<?php echo $d["gambar"]; ?>" style="width: 200px; height:200px;" alt="foto-informasi">
                                    <br>
                                    <br>
