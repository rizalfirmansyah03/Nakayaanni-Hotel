<?php
    ...
    $id = $_GET["id"];
    $psn = "SELECT * FROM tb_kontak WHERE id_kontak = '$id'";
				...
				<div class="container-fluid px-3 py-2">
                    <div class="card mb-4">
	                    ...
	                    <form action="editkontak.php" method="POST">
		                    <input type="hidden" name="id_kontak" value="<?php echo $d['id_kontak']; ?>">
		                    <ul style="background-color: #E4E9F7;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="" class="form-control" name="email" id="email" required value="<?php echo $d["email"]; ?>">
		                        </div>
                                <div class="mb-3">
				                    <label for="subjek">Subjek : </label>
                                    <input type="" class="form-control" name="subjek" id="subjek" required value="<?php echo $d["subjek"]; ?>">
		                        </div>
                                <div class="mb-3">
				                    <label for="pesan">Pesan : </label>
                                    <input type="" class="form-control" name="pesan" id="pesan" required value="<?php echo $d["pesan"]; ?>">
		                        </div>
			                    <div class="mb-3">
