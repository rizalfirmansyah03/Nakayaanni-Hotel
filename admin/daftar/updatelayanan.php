<?php
    ...
    $id = $_GET["id"];
    $psn = "SELECT * FROM tb_layanan WHERE id_layanan = '$id'";
	                    ...
	                    <form action="editlayanan.php" method="POST">
		                    ...
		                    <ul style="background-color: #E4E9F7;">
			                    <div class="mb-3">
                                    ...
                                    <input type="" class="form-control" name="judul" id="judul" required value="<?php echo $d["judul"]; ?>">
		                        </div>
                                <div class="mb-3">
				                    <label for="judul">Keterangan : </label>
                                    <textarea type="text" class="form-control" rows="2" name="keterangan" id="keterangan" required ><?php echo $d["keterangan"]; ?></textarea>
		                        </div>
			                    <div class="mb-3">
