    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #000000;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-tabs">
                        <a class="nav-link active text-warning" href="fasilitas.php">Fasilitas</a>
                    </li>
                    <li class="nav-pills">
        ...
        <section>
            <div class="container mb-5">
                <div class="row mb-2">
                    <div class="col-md text-center">
                        <h3 style = "font-family:geneva;">Fasilitas Hotel</h3>
                        <hr>
                    </div>
                </div>
            </div>
        ...
        <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="card">
                                ...
                                <img src="asset/<?php echo $hasil['gambar_fasilitas']; ?>" width="100" height="200" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title text-center text-warning"><?php echo $hasil['nama_fasilitas']; ?></h5>
                                </div>
                                <ul class="list-group list-group-flush" style="margin-bottom:50px;">
                                    <li class="list-group-item text-center"><?php echo $hasil['keterangan']; ?></li>
                                </ul>
                            </div>    
                        </div>
                        <?php } ?>
            ...
            <nav class="text-warning">
                <ul class="pagination justify-content-center">
                    <li class="page-item">
                        <a class="page-link text-warning" style="background-color: #000000;" 
                            <?php if ($halaman > 1) {
                    ...
                    ?>
                        <li class="page-item"><a class="page-link text-warning" style="background-color: #000000;" href="fasilitas.php?halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                    <?php
                    }
                    ?>
                    <li class="page-item">
