    ...
    <body>
            ...
            <div class="container mt-5">
                <div class="row mb-2">
                    <div class="col-md text-center">
                        <h1 style = "font-family:geneva;" class="text-dark">
                            Nakayaanni Hotel
                        </h1>
                        <hr>
                    </div>
                ...
                <div>
                    <div class="col-md text-center mb-5">
                        <?php 
                            $query = "SELECT deskripsi FROM tb_deskripsi";
                            $result = mysqli_query($conn, $query);
                            while($row = mysqli_fetch_array($result)) { 
                        ?>
                        <p style = "font-family:cambria;"> <font size="4"><?php echo $row["deskripsi"]; ?></font></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container mb-5">
                <div class="row mb-2">
                    <div class="col-md text-center">
                        <h3 style = "font-family:geneva;">Kamar Tamu</h3>
                        <hr>
                    </div>
                </div>
                <div class="col-md mb-5">
                    <h5>Semua Fitur Kamar Kami</h5>
                    <div class="row">
                        <div class="col-md-6 col-md-offset-0 Column1 text">
                            <ul>
                                <li><?php foreach ($fitur1 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur2 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur3 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur4 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur5 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur6 as $hasil) { echo $hasil['jenis_fitur']; } ?></li> 
                            </ul>
                        </div>
                        <div class="col-md-6 col-md-offset-0 Column2 ColumnLast text">
                            <ul>
                                <li><?php foreach ($fitur7 as $hasil) { echo $hasil['jenis_fitur']; } ?></li> 
                                <li><?php foreach ($fitur8 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur9 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                                <li><?php foreach ($fitur10 as $hasil) { echo $hasil['jenis_fitur']; } ?></li>
                            </ul>
                        </div>
                    </div>        
                </div>
                <li style='list-style-type: none;' class=" text-center">
                    <div class="row">
                        <div class="col-md">
                            <div class="card" >
                                <?php foreach ($room1 as $hasil) { ?>
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/singroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="card" >
                                ...
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/stdroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="card" >
                                ...
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/sprroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div class="card" >
                                ...
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/dblroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="card" >
                                ...
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/delroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="card" >
                                ...
                                <img src="asset/<?php echo $hasil['gambar']; ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="room/presroom.php"><h5 class="card-title text-center text-warning"><?php echo $hasil['nr']; ?></h5></a>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
        ...
        <section class="homelayanan" id="homelayanan">
            <div class="container mb-5">
                <div class="row mb-2">
                    <div class="col-md text-center">
                        <h3 style = "font-family:geneva;">Layanan Nakayaanni Hotel</h3>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
                        <div class="card">
                            <div class="card-body bg-danger">
                                <?php foreach ($layanan1 as $hasil) { ?>
                                <h6 class="card-title text-center"><?php echo $hasil['judul']; ?></h6>
                            </div>
                            <ul class="list-group list-group-flush bg-light">
                                <li style='list-style-type: none;' class="list-group-pills text-center"><?php echo $hasil['keterangan']; ?></li>
                            </ul>
                            <?php } ?>
                        </div>
                    </div>
