            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-tabs dropdown">
                        <a class="nav-link active dropdown-toggle text-warning" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-expanded="false">
                        Rooms
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <?php foreach ($room1 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="singroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>
                            <?php foreach ($room2 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="stdroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>    
                            <?php foreach ($room3 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="sprroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>
                            <?php foreach ($room4 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="dblroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>
                            <?php foreach ($room5 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="delroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>
                            <?php foreach ($room6 as $hasil) { ?>
                            <a class="dropdown-item text-warning" href="presroom.php"><?php echo $hasil['nr']; ?></a>
                            <?php } ?>
                        </div>
                    </li>
                    <li class="nav-pills">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md stdreser">
                    <h2>Reservasi <?php echo $hasil['nr']; ?></h2>
                    <hr>
                </div>
            </div>
            <div class="row mb-5">
                <div class="col-md-5">
                    <form action="insert.php" method="POST">
                        ...
                        <input type="hidden" name="id_room" value="<?php echo $hasil['idr']; ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" pattern="^\d{12}$" class="form-control" id="no_hp" name="no_hp" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="submit" class="btn btn-warning">Pesan Sekarang</button>
                    </form>
